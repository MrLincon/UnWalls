...
public class CategoryDetailsViewPagerAdapter extends PagerAdapter {
    ...
    public CategoryDetailsViewPagerAdapter(Context mContext, ArrayList<ImageModel> list, int itemPosition) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = inflater.inflate(R.layout.category_details_layout,container,false);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((CategoryDetailsActivity)mContext).finish();
            }
        });
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomSheetSetWallpaper.show(((CategoryDetailsActivity)mContext).getSupportFragmentManager(), "Set wallpaper");
            }
        });
